...
export const MainSidebar = ({ children }) => {
  ...
  const navItems = [
    ...
    ...(userRole !== "user"
      ? [
          { name: "Courier Requests", icon: Calendar, href: "/courier" },
          { name: "Track Application", icon: TrainTrack, href: "/track-application" },
          { name: "Manage Permissions", icon: Users, href: "/permissions" },
        ]
      : []),
    // { name: "Contact Us", icon: Settings, href: "/contact-us" },
  ];
  console.log("Main",isDarkMode)
  return (
    <div
